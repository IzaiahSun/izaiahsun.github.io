...
\PassOptionsToPackage{style=ieee,sorting=ydnt,uniquename=init,defernumbers=true,minbibnames=5,maxbibnames=5}{biblatex}
...
\leftheader{%
  {\Huge \textsc{\textsc{Yuqiang Sun, Ph.D.}}} \\\hrule\bigskip

  \makefield{\faEnvelope[regular]}{\href{mailto:yuqiang.sun@ntu.edu.sg}{\texttt{yuqiang.sun@ntu.edu.sg}}}
